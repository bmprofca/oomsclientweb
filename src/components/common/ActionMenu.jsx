...
const ActionMenu = ({ actions = [], activeId, onToggle, menuId, trigger }) => {
  ...
  const menuPortal = isMenuOpen ? createPortal(
    <motion.div
      ...
      className="overflow-hidden rounded-md border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-1.5 shadow-xl shadow-slate-200/70 dark:shadow-gray-950/60 backdrop-blur-xl ring-1 ring-slate-900/5 dark:ring-white/10"
    >
