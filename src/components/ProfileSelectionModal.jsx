...
const ProfileSelectionModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div 
        className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200"
            ...
            <div className="flex flex-col gap-3">
              {profiles.map((profile, idx) => (
                <div
                  ...
                  className="p-4 border-[1.5px] border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer transition-all duration-200 hover:border-slate-800 hover:bg-slate-50 dark:hover:bg-gray-700 dark:hover:border-gray-500 flex flex-col gap-1"
                >
